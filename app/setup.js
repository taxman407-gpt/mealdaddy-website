import { supabase, requireSession } from "./supabase-client.js?v=20260811-2";
import { normalizeUnitSystem, suggestedStartingTargets, weightToKg, weightUnit } from "./health-metrics.js?v=20260811-2";
